...
** Date: 5/22/2018
** Description: This is the header file for the Medusa class. It is a child class of
the Character class. In addtion to the variables and functions inherited from that class,
it has 2 attackDice variables, and 1 defenseDice variable to store the results returned
...
public:
	...
	Medusa(int, int, std::string);	// Will use base class constructor to set values
